...
void setup_wifi() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.println("No se pudo conectar al WiFi (timeout).");
  }
}
...
void loop() {
  ...
  if (sample_count >= limit_refresh) {
    ...
    json += "\"min_ay\":" + String(fs_ay.minVal, 3) + ",";
    json += "\"min_az\":" + String(fs_az.minVal, 3) + ",";

    json += "\"max_ax\":" + String(fs_ax.maxVal, 3) + ",";
    json += "\"max_ay\":" + String(fs_ay.maxVal, 3) + ",";
    json += "\"max_az\":" + String(fs_az.maxVal, 3) + ",";
    ...
    json += "\"max_gy\":" + String(fs_gy.maxVal, 3) + ",";
    json += "\"max_gz\":" + String(fs_gz.maxVal, 3) + ",";
